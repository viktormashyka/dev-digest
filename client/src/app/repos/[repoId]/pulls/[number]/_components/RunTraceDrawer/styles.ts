...
export const s = {
  ...
  specsWrap: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minWidth: 0 } satisfies CSSProperties,
  ...
  specPath: { fontSize: 12, color: "var(--text-primary)", wordBreak: "break-all" } satisfies CSSProperties,
  specOrigin: { fontSize: 12, color: "var(--text-muted)" } satisfies CSSProperties,
  specTokens: { fontSize: 12, color: "var(--text-secondary)" } satisfies CSSProperties,
  specReason: { fontSize: 12, color: "var(--text-muted)", fontStyle: "italic" } satisfies CSSProperties,
